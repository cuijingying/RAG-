...
本项目基于 LangChain + Chroma + DeepSeek + Streamlit 技术栈开发的 RAG问答系统。
...
- 安装 Docker Desktop（Mac: https://docs.docker.com/desktop/setup/install/mac-install/）
- 下载并配置 DeepSeek API Key
